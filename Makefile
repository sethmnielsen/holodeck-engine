...
UNREALROOTPATH = /home/seth/dev/ue4/UnrealEngine-4.22.3
...
Holodeck-Linux-Debug:
	 $(PROJECTBUILD) Holodeck Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Holodeck-Linux-DebugGame:
	 $(PROJECTBUILD) Holodeck Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Holodeck-Linux-Shipping:
	 $(PROJECTBUILD) Holodeck Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Holodeck-Linux-Test:
	 $(PROJECTBUILD) Holodeck Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Holodeck:
	 $(PROJECTBUILD) Holodeck Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

HolodeckEditor-Linux-Debug:
	 $(PROJECTBUILD) HolodeckEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

HolodeckEditor-Linux-DebugGame:
	 $(PROJECTBUILD) HolodeckEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

HolodeckEditor-Linux-Shipping:
	 $(PROJECTBUILD) HolodeckEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

HolodeckEditor-Linux-Test:
	 $(PROJECTBUILD) HolodeckEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

HolodeckEditor:
	 $(PROJECTBUILD) HolodeckEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
